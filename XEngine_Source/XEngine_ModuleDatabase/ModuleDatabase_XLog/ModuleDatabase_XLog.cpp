...
BOOL CModuleDatabase_XLog::ModuleDatabase_XLog_Create(LPCTSTR lpszTableName)
{
	...
	"`tszFileName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '文件名',"
	"`tszFuncName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '函数名',"
	"`nLogLine` int NOT NULL COMMENT '第几行',"
	"`nLogLevel` int NOT NULL COMMENT '打印级别',"
