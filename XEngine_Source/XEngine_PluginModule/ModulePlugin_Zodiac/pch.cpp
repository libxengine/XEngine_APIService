...
{
	return m_PluginZodiac.PluginCore_RegisterType();
}
...
extern "C" bool PluginCore_Call(XCHAR* ptszMsgBuffer, int* pInt_MsgLen, LPCXSTR lpszMsgBuffer, int nMsgLen, XCHAR*** pppInputParameters, int nInputPCount, XCHAR*** pppOutputParameters, int* pInt_OutputPCount)
{
	return m_PluginZodiac.PluginCore_Call(ptszMsgBuffer, pInt_MsgLen, lpszMsgBuffer, nMsgLen, pppInputParameters, nInputPCount, pppOutputParameters, pInt_OutputPCount);
}