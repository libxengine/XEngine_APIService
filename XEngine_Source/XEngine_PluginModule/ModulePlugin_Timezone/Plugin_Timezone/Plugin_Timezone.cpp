...
备注：
*********************************************************************/
bool CPlugin_Timezone::PluginCore_Init(XENGINE_PLUGINPARAM *pSt_PluginParameter)
{
...
备注：
*********************************************************************/
void CPlugin_Timezone::PluginCore_GetInfo(XCHAR* ptszPluginName, XCHAR* ptszPluginVersion, XCHAR* ptszPluginAuthor, XCHAR* ptszPluginDesc)
{
	Timezone_IsErrorOccur = false;

	_tcsxcpy(ptszPluginName, "timezone");
	_tcsxcpy(ptszPluginVersion, "1.0.0.1001");
	_tcsxcpy(ptszPluginAuthor, "xengine");
	_tcsxcpy(ptszPluginDesc, "get timezone info for XEngine API Service");
}
/********************************************************************
...
//                       保护函数
//////////////////////////////////////////////////////////////////////////
bool CPlugin_Timezone::Plugin_Timezone_Count(XCHAR* ptszMsgBufer, int* pInt_Len)
{
	Timezone_IsErrorOccur = false;
...
bool CPlugin_Timezone::Plugin_Timezone_List(LPCXSTR lpszConvert, XCHAR* ptszMsgBufer, int* pInt_Len)
{
	Timezone_IsErrorOccur = false;
...
bool CPlugin_Timezone::Plugin_Timezone_Convert(LPCXSTR lpszConvert, LPCXSTR lpszTimeStr, XCHAR* ptszMsgBufer, int* pInt_Len)
{
	Timezone_IsErrorOccur = false;
	...
	_xsntprintf(tszTimeStr, sizeof(tszTimeStr), _X("%04d-%02d-%02d %02d:%02d:%02d"), st_TimeEnd.wYear, st_TimeEnd.wMonth, st_TimeEnd.wDay, st_TimeEnd.wHour, st_TimeEnd.wMinute, st_TimeEnd.wSecond);
