...
{
	return m_PluginTimes.PluginCore_RegisterType();
}
...
{
	return m_PluginTimes.PluginCore_Call(ptszMsgBuffer, pInt_MsgLen, lpszMsgBuffer, nMsgLen, pppInputParameters, nInputPCount, pppOutputParameters, pInt_OutputPCount);
}